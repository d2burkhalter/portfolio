...
#parse lines for movie_id and tag
def parse_line(line):
  fields = line.split(",")
...
#joins the distinct rdd with tags to unformatted imdb_id
...
def save_to_db(list_of_tuples):
    ...
    cur = conn.cursor()
    #gets imdb id and tag from each tuple
    for tupl in list_of_tuples:
        imdb_id_str, tag = tupl
        #insert statement to put tuple into database
